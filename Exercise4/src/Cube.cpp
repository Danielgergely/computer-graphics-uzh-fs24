		...
		*/
        ...
        for(int i = 0; i < positions.size(); i++) {
            ...
            if (i < 4 || (i >= 8 && i < 12) || (i >= 16 && i < 20)) {
                tangent = glm::vec3(1.0f, 0.0f, 0.0f);  // Right
            } else if (i >= 4 && i < 8) {
                tangent = glm::vec3(-1.0f, 0.0f, 0.0f);  // Left
            } else if (i >= 12 && i < 16) {
                tangent = glm::vec3(0.0f, -1.0f, 0.0f);  // Down
            } else if (i >= 20 && i < 24) {
                tangent = glm::vec3(0.0f, 1.0f, 0.0f);  // Up
            }
